...
def plot_loss(
    ...
    """
    # Generate epochs for training los͏󠄀͏󠄍͏︃͏︆͏︀͏︀͏︋͏󠄍͏󠄇͏󠄀͏󠄎͏󠄒͏︎͏󠄇͏︈͏︃͏︁s
    epochs1 = np.arange(len(loss_values))
    loss_values = np.array(loss_values)

    # Initialize plo͏󠄀͏󠄍͏︃͏︆͏︀͏︀͏︋͏󠄍͏󠄇͏󠄀͏󠄎͏󠄒͏︎͏󠄇͏︈͏︃͏︁t
    plt.figure(figsize=(10, 6))
    plt.plot(epochs1, loss_values, color="b", label="Training Loss")
    plt.fill_between(epochs1, loss_values, color="b", alpha=0.1)

    # Generate epochs for validation loss, aligned with eval_interva͏󠄀͏󠄍͏︃͏︆͏︀͏︀͏︋͏󠄍͏󠄇͏󠄀͏󠄎͏󠄒͏︎͏󠄇͏︈͏︃͏︁l
    ...
    # Set y-axis limits based on both loss array͏󠄀͏󠄍͏︃͏︆͏︀͏︀͏︋͏󠄍͏󠄇͏󠄀͏󠄎͏󠄒͏︎͏󠄇͏︈͏︃͏︁s
    all_losses = (
    ...
    # Formattin͏󠄀͏󠄍͏︃͏︆͏︀͏︀͏︋͏󠄍͏󠄇͏󠄀͏󠄎͏󠄒͏︎͏󠄇͏︈͏︃͏︁g
    plt.xlabel("Epoch")
    plt.ylabel("Loss")
    ...
    # For dynamic display in Jupyter Noteboo͏󠄀͏󠄍͏︃͏︆͏︀͏︀͏︋͏󠄍͏󠄇͏󠄀͏󠄎͏󠄒͏︎͏󠄇͏︈͏︃͏︁k
